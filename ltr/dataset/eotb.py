...
class EOTB(BaseVideoDataset):
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        # seq_name = se
        img_path = os.path.join(seq_path, 'img', '{:05}.jpg'.format(gray_id))
        return  img_path
        # return os.path.join(seq_path, 'img', '{}.jpg'.format(frame_id + 1))
    ...
    def _get_event(self, seq_path, frame_id):
        pos_path = os.path.join(seq_path, 'stack240','{:05}.jpg'.format(frame_id+1))
