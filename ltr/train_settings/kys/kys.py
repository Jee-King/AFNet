...
import os
from ltr.dataset import Lasot, Got10k, TrackingNet,EOTB
...
def run(settings):
    ...
    dataset_train = sampler.KYSSampler([eotb_train],
                                       [1],
    ...
    dataset_val = sampler.KYSSampler([eotb_test], [1], samples_per_epoch=1000,
